...
import { getColorForLabel, ambosOriginFillColor, ambosSeriesLegendFill } from "../utils/categoryColors.js?v=20260501h";
import { scrollPanelElementIntoView } from "../ui/textPanel.js?v=20260603t";
import {
  ENTITY_POINT_LABEL_COLOR,
  WORKSPACE_AXIS_TICK_COLOR,
  extentFromScatterNodes,
  normalizeArticleFrozenAxis,
} from "../utils/chartAxisUtils.js?v=20260606_axis_auto";
import { relationLineCurveness } from "../utils/relationLineCurveness.js?v=20260601c";
